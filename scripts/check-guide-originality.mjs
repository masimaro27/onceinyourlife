...
const PAIRS = [
  ...
  ['pension/saving-credit/index.html', ['24_연금저축세액공제', '25_비과세개인연금']],
  ['pension/irp-withdraw/index.html', ['23_IRP퇴직연금수령', '24_연금저축세액공제']],
  ['pension/health-checkup/index.html', ['26_국가건강검진']],
  ['car/which-inspection/index.html', ['18_자동차종합검사비용', '20_자동차민간검사소', '22_자동차검사조회']],
  ['car/deadline-fine/index.html', ['22_자동차검사조회', '18_자동차종합검사비용']],
  ['car/transfer/index.html', ['19_자동차매매']],
  ['inherit/first-30-days/index.html', ['9_상속절차', '17_상속세신고방법']],
  ['inherit/division/index.html', ['10_상속재산분할', '9_상속절차']],
  ['inherit/registration-papers/index.html', ['11_상속등기서류', '9_상속절차']],
  ['inherit/cohabit-deduction/index.html', ['21_동거주택상속공제']],
  ...
  ['silup/guide/why-different/index.html', ['2_실업급여계산', '3_고용보험실업급여조건', '1_실업급여신청하는곳']],
];
